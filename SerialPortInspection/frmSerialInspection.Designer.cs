namespace SerialPortInspection {
	partial class frmSerialInspection {
		/// <summary>
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmSerialInspection));
			...
			this.cmbPorts.Location = new System.Drawing.Point(55, 27);
			...
			// btnOpen
			// 
			this.btnOpen.Location = new System.Drawing.Point(11, 65);
			...
			// btnClose
			// 
			this.btnClose.Location = new System.Drawing.Point(101, 65);
			...
			this.gpbSerial.Controls.Add(this.cmbPorts);
			this.gpbSerial.Controls.Add(this.btnOpen);
			this.gpbSerial.Controls.Add(this.btnClose);
